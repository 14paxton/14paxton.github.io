            ...
            if (request.status >= 200 && request.status < 400) {
                ...
                var index = lunr(function () {
                    ...
                    for (var i in docs) {
                        ...
                        this.add({
                            id: i, title: docs[i].title, content: docs[i].content, relUrl: docs[i].relUrl
                        });
                    }
                });
                    ...
                    if (meta.content) {
                        ...
                        for (var k in positions) {
                            ...
                            contentPositions.push({
                                highlight: position, previewStart: previewStart, previewEnd: previewEnd, ellipsesBefore: ellipsesBefore, ellipsesAfter: ellipsesAfter
                            });
                        }
                    }
                }
